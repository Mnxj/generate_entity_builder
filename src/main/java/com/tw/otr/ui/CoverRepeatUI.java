...
public class CoverRepeatUI extends DialogWrapper {
    boolean generateFileFlag;

    public CoverRepeatUI() {
        super(true);
        init();
    }
    ...
    protected JComponent createCenterPanel() {
        ...
        contentPane.setLayout(new GridLayoutManager(2, 1, JBUI.insets(10), -1, -1));
        ...
        panel2.setLayout(new GridLayoutManager(1, 4, JBUI.emptyInsets(), -1, -1));
        ...
        panel3.setLayout(new GridLayoutManager(3, 1, JBUI.emptyInsets(), -1, -1));
